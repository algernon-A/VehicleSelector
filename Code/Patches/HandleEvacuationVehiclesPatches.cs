// <copyright file="HandleEvacuationVehiclesPatches.cs" company="algernon (K. Algernon A. Sheppard)">
...
namespace VehicleSelector
{
    ...
    /// <summary>
    /// Harmony transpiler to implement shleter evacuation vehicle selection.
    /// </summary>
    [HarmonyPatch(typeof(ShelterAI), "HandleEvacuationVehicles")]
    public static class HandleEvacuationVehiclesPatches
    {
        /// <summary>
        /// Harmony transpiler for ShelterAI.HandleEvacuationVehicles, replacing existing calls to VehicleManager.GetRandomVehicleInfo with a call to our custom replacement instead.
        /// </summary>
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, MethodBase original)
        {
            ...
            MethodInfo chooseVehicle = AccessTools.Method(typeof(HandleEvacuationVehiclesPatches), nameof(ChooseVehicle));
        ...
        public static VehicleInfo ChooseVehicle(VehicleManager vehicleManager, ref Randomizer r, ItemClass.Service service, ItemClass.SubService subService, ItemClass.Level level, ushort buildingID)
        {
            ...
            List<VehicleInfo> vehicleList = VehicleControl.GetVehicles(buildingID, TransferManager.TransferReason.EvacuateA);
            if (vehicleList == null)
            {
