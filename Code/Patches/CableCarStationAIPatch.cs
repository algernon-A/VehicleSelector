// <copyright file="CableCarStationAIPatch.cs" company="algernon (K. Algernon A. Sheppard)">
...
namespace VehicleSelector
{
    ...
    /// <summary>
    /// Harmony transpiler to implement cable car selection.
    /// </summary>
    [HarmonyPatch(typeof(CableCarStationAI), "CreateVehicle")]
    public static class CableCarStationAIPatch
    {
        /// <summary>
        /// Harmony transpiler for CableCarStationAI.CreateVehicle, replacing existing calls to VehicleManager.GetRandomVehicleInfo with a call to our custom replacement instead.
        /// </summary>
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, MethodBase original)
        {
            ...
            MethodInfo chooseVehicle = AccessTools.Method(typeof(CableCarStationAIPatch), nameof(ChooseVehicle));
        ...
        /// <param name="stationAI">Cable car station AI instance.</param>
        /// <returns>Vehicle prefab to spawn.</returns>
        public static VehicleInfo ChooseVehicle(VehicleManager vehicleManager, ref Randomizer r, ItemClass.Service service, ItemClass.SubService subService, ItemClass.Level level, ushort buildingID, CableCarStationAI stationAI)
        {
            // Get any custom vehicle list for this building.
            List<VehicleInfo> vehicleList = VehicleControl.GetVehicles(buildingID, stationAI.m_transportInfo.m_vehicleReason);
            if (vehicleList == null)
            {
